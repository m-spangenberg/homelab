...
![Linting](https://img.shields.io/github/actions/workflow/status/m-spangenberg/homelab/validate.yml?branch=main&label=lint&style=flat-square)![Longhorn](https://img.shields.io/badge/Storage-Longhorn-orange?style=flat-square)
...
![Kubeadm](https://img.shields.io/badge/Kubeadm-blueviolet?style=flat-square)
